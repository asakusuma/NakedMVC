define([
  ...
  setData: function(query, data) {
  	if(data && data.attributes) {
        ...
        //Register event for handling updates that originated on the current client
        this.data.on('originChange', _.bind(this.dataUpdatedByMe,this));
...
onPostRender: function() {
  ...
  dataUpdatedByMe: function() {
  	//console.log("I UPDATED MYSELF!!!");
  	if(this.data.attributes.cards.length !== this.numCards) {
  		this.dataUpdated();
  	}
  },
...
postRender: function() {
    ...
    cardDragged: function() {
    	...
    	this.data.set('layout', layout, true);
    },
    remove: function() {
    	this.off();
    	this.el.empty();
